...
@RunWith(RobolectricTestRunner.class) public class SimpleBillingRemoteExceptionTest
    extends BadBillingTest {
  @Override IInAppBillingService service() {
    return new RemoteExceptionBillingService();
  }

  static final class RemoteExceptionBillingService implements IInAppBillingService {
